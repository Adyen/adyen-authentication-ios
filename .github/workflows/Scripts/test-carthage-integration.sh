...
targets:
  $PROJECT_NAME:
    ...
    dependencies:
      - framework: Carthage/Checkouts/
adyen-authentication-ios/XCFramework/Dynamic/AdyenAuthentication.xcframework
        embed: true
        codeSign: true
  Tests:
...
cp "../.github/workflows/AdyenAuthenticationTestApp.swift" Source/ThreeDS2TestApp.swift
